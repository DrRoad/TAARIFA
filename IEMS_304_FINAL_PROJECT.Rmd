...
gbm <- gbm(status_group ~ ., data=train.gbm, distribution="multinomial")
eval.gbm(gbm, n.trees=100)

# Increasing number of trees
gbm <- gbm(status_group ~ ., data=train.gbm, distribution="multinomial", n.trees=1000)
eval.gbm(gbm, n.trees=1000)
